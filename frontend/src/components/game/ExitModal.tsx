        ...
        <>
          ...
          >
            <div className="w-full max-w-sm overflow-hidden rounded-2xl bg-white shadow-2xl pointer-events-auto">
              <div className="h-1.5 w-full bg-gradient-to-r from-[#922B21] via-[#C0392B] to-[#E74C3C]" />
              ...
              <div className="px-5 pt-4 pb-3 sm:px-6 sm:pt-5 sm:pb-4">
                <div className="mb-3 flex items-start justify-between sm:mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-[#C0392B] font-semibold mt-0.5 uppercase tracking-wide">Progress will reset</p>
                    </div>
                  </div>
                  <button
                    onClick={onClose}
                ...
                <div className="flex flex-col-reverse sm:flex-row gap-2.5 sm:gap-3">
                  ...
                  <button
                    onClick={onConfirm}
                    className="flex-1 py-2.5 px-4 rounded-xl bg-[#C0392B] text-sm font-semibold text-white hover:bg-[#922B21] transition-colors"
                  >
                    Exit Now
                  </button>
                </div>
